...
<div align="center" class="alignment" style="line-height:10px"><img src="cid:biglogo.png" style="display: block; height: auto; border: 0; max-width: 600px; width: 100%;" width="600"/></div>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<h1 style="margin: 0; color: #ffba26; direction: ltr; font-family: Arial, Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Доброго дня ${name}! Ви зареєструвалися в системі VoluTrack, для активації аккаунту натисніть на клавішу нижче цього повідомлення, Слава Україні! </span></h1>
</td>
</tr>
</table>
...
<div align="center" class="alignment">
	<a href="${link}" style=\"text:center;padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;word-break:break-word;line-height:32px;">Активувати</a>
</div>
</td>
</tr>
</table>
